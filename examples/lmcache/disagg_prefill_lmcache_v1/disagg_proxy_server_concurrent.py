...
async def handle_completions(request: Request):
    ...
    try:
        ...
        # Start prefill request but don't await it
        prefill_task = send_request_to_service(app.state.prefill_client, "/completions", req_data)
        
        # Start streaming response immediately without waiting for prefill
        ...
        print("Error occurred in concurrent disagg prefill proxy server"
...
async def handle_chat_completions(request: Request):
    ...
    try:
        ...
        # Start prefill request but don't await it
        prefill_task = send_request_to_service(app.state.prefill_client,
